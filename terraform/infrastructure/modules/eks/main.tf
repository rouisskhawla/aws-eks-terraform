...
resource "aws_eks_access_entry" "deploy_eks_access_entry" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  principal_arn = var.deploy_role_arn
}

resource "aws_eks_access_policy_association" "deploy_eks_access_policy_association" {
  cluster_name  = aws_eks_cluster.eks_cluster.name
  principal_arn = var.deploy_role_arn
  ...
  depends_on = [aws_eks_access_entry.deploy_eks_access_entry]
}
